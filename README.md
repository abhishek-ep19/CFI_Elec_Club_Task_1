...
### [1. Receiving Images From Passing Weather Satellites (NOAA and METEOR M2) Using a Cheap SDR](https://www.instructables.com/id/Receiving-Images-From-Passing-Weather-Satellites-N/)
...
### [2. Game That Learns How to Play Itself](https://hackaday.io/project/170977-a-game-that-learns-how-to-play-itself)
...
### [3. Electronic Stamp](https://web.archive.org/web/20161227143017/https://spritesmods.com/?art=inker&page=1)
...
### [4. Eco-friendly metal detector - Arduino](https://www.instructables.com/id/Eco-Friendly-Arduino-Metal-Detector/)
...
### [5. Raspberry Pi micro arcade machine](https://www.instructables.com/id/Micro-Raspberry-Pi-arcade-cabinet/)
...
### [6. Cell Phone Operated Land Rover](https://www.electronicsforu.com/electronics-projects/hardware-diy/cellphone-operated-land-rover-2)
...
### [7. Handwriting Recognition](https://www.hackster.io/naveenbskumar/handwriting-recognition-7583e3)
...
### [8. Speech Recognition at the Edge](https://www.hackster.io/naveenbskumar/handwriting-recognition-7583e3)
...
### [10. Internet Controlled LED Strip Using ESP32 + Arduino](https://www.hackster.io/donowak/internet-controlled-led-strip-using-esp32-arduino-2ca8a9)
...
### [11. ESP32 Xiaomi Hack - Get Data Wirelessly](https://www.instructables.com/id/ESP32-Xiaomi-Hack-Get-Data-Wirelessly/)
...
### [13. Personal Assistant](https://www.instructables.com/id/Personal-Assistant/)
...
### [14. Video Card made on Breadboard](https://www.youtube.com/watch?v=l7rce6IQDWs)
...
### [15. Raspberry Pi Radio](https://www.instructables.com/id/Raspberry-Pi-Radio/)
...
### [16. Gesture Controlled Universal Remote With Node-MCU](https://www.instructables.com/id/Gesture-Controlled-Universal-Remote-With-Node-MCU/)
...
### [17. Arduino & Sony Ericsson: Gsm Shield Hack](https://www.instructables.com/id/arduino-sony-ericsson-gsm-shield-hack/)
...
### [18. ATtiny85 Mini Arcade: Snake](https://create.arduino.cc/projecthub/gatoninja236/attiny85-mini-arcade-snake-a0fc56)
...
### [19. ESP32 + MPU9250: 3D Orientation Visualisation](https://www.hackster.io/donowak/esp32-mpu9250-3d-orientation-visualisation-467dc1)
...
### [20. Arduino Cell Phone 4G Signal Booster / Repeater](https://www.instructables.com/id/Arduino-Cell-Phone-4G-Signal-Booster-Repeater/)
...
### [21. Micromouse Autonomous Vehicle Kit](https://www.hackster.io/brenden-black/micromouse-autonomous-vehicle-kit-8101ed)
The user interface being used for this project has several components. Two of these are programmable by the user.
The third button is an onboard hardware reset button, allowing the user to quickly reset the microcontroller to the power up state. The two programmable buttons are connected to GPIO pins configured with internal pull ups, resulting in the buttons simply being connected to ground outside the microcontroller.
...
### [22. Arduino Menu with APDS 9960 Gesture Sensor Control](https://create.arduino.cc/projecthub/moreirarobotics/arduino-menu-with-apds-9960-gesture-sensor-control-b9c71e)
...
### [24. Sense HAT data logger](https://projects.raspberrypi.org/en/projects/sense-hat-data-logger)
...
### [25. GooglePi - Google Assistant on Raspberry Pi](https://www.hackster.io/Salmanfarisvp/googlepi-google-assistant-on-raspberry-pi-9f3677)
